...
class PapayaUtilServerProtocolTest extends \PapayaTestCase {
  ...
  */
  public function testGetExpectingHttps() {
    $_SERVER['HTTPS'] = 'On';
    $this->assertEquals(
      'https', \Papaya\Utility\Server\Protocol::get()
    );
  }
  ...
  */
  public function testGetExpectingHttp() {
    $_SERVER['HTTPS'] = NULL;
    $this->assertEquals(
      'http', \Papaya\Utility\Server\Protocol::get()
    );
  }
  ...
  */
  public function testGetWithParameterExpectingHttp() {
    $this->assertEquals(
      'http', \Papaya\Utility\Server\Protocol::get(\Papaya\Utility\Server\Protocol::HTTP)
    );
  }
  ...
  */
  public function testGetWithParameterExpectingHttps() {
    $this->assertEquals(
      'https', \Papaya\Utility\Server\Protocol::get(\Papaya\Utility\Server\Protocol::HTTPS)
    );
  }
  ...
  */
  public function testGetDefaultPortExpectingHttps() {
    $_SERVER['HTTPS'] = 'On';
    $this->assertEquals(
      443, \Papaya\Utility\Server\Protocol::getDefaultPort()
    );
  }
  ...
  */
  public function testGetDefaultPortExpectingHttp() {
    $_SERVER['HTTPS'] = NULL;
    $this->assertEquals(
      80, \Papaya\Utility\Server\Protocol::getDefaultPort()
    );
  }
