...
namespace Papaya\CMS\Output\Teasers;
require_once __DIR__.'/../../../../../bootstrap.php';

class FactoryTest extends \Papaya\TestFramework\TestCase {

  /**
   * @covers \Papaya\CMS\Output\Teasers\Factory
   */
  public function testByFilterWithParentIdAndViewId() {
    ...
    $this->assertInstanceOf(\Papaya\CMS\Output\Teasers::class, $teasers);
    $this->assertInstanceOf(\Papaya\CMS\Content\Page\Publications::class, $teasers->pages());
  ...
  public function testByParentWithOnePageIdInPreviewMode() {
    ...
    $this->assertInstanceOf(\Papaya\CMS\Output\Teasers::class, $teasers);
    $this->assertInstanceOf(\Papaya\CMS\Content\Pages::class, $teasers->pages());
    $this->assertNotInstanceOf(\Papaya\CMS\Content\Page\Publications::class, $teasers->pages());
  }
