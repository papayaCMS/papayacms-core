...
class TranslationTest extends \Papaya\TestFramework\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Content\Box\Translation::load
   * @covers \Papaya\CMS\Content\Box\Translation::convertBoxRecordToValues
   */
  ...
  /**
   * @covers \Papaya\CMS\Content\Box\Translation::save
   * @covers \Papaya\CMS\Content\Box\Translation::_insert
   */
  ...
  /**
   * @covers \Papaya\CMS\Content\Box\Translation::save
   * @covers \Papaya\CMS\Content\Box\Translation::_update
   */
