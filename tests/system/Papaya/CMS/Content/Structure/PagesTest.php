...
class PagesTest extends \Papaya\TestFramework\TestCase {

  /**
   * @covers \Papaya\CMS\Content\Structure\Pages::__construct
   */
  ...
  /**
   * @covers \Papaya\CMS\Content\Structure\Pages::load
   */
