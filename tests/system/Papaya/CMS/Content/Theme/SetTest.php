...
class SetTest extends \Papaya\TestFramework\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Content\Theme\Skin::mapFieldToProperty
   */
  ...
  /**
   * @covers \Papaya\CMS\Content\Theme\Skin::mapPropertyToField
   */
  ...
  /**
   * @covers \Papaya\CMS\Content\Theme\Skin::getValuesXML
   */
  public function testGetValuesXml() {
    /** @var \PHPUnit_Framework_MockObject_MockObject|\Papaya\CMS\Content\Structure $definition */
  ...
  /**
   * @covers \Papaya\CMS\Content\Theme\Skin::setValuesXML
   */
