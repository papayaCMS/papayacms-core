...
namespace Papaya\CMS\Content\Page {
  ...
  class WorkTest extends \Papaya\TestFramework\TestCase {

    /**
     * @covers \Papaya\CMS\Content\Page\Work::save
     */
    ...
    public function checkInsertData($table, $idField, $data) {
      ...
      $this->assertEquals(
        \Papaya\CMS\Content\Options::INHERIT_PERMISSIONS_OWN, $data['surfer_useparent']
      );
      ...
      $this->assertEquals(\Papaya\CMS\Content\Options::SCHEME_SYSTEM, $data['topic_protocol']);
      $this->assertEquals(\Papaya\CMS\Content\Options::CACHE_SYSTEM, $data['topic_cachemode']);
      $this->assertEquals(0, $data['topic_cachetime']);
      $this->assertEquals(\Papaya\CMS\Content\Options::CACHE_SYSTEM, $data['topic_expiresmode']);
    ...
    public function checkUpdateData($table, $data, $filter) {
      ...
      $this->assertEquals(-1, $data['author_group']);
      $this->assertEquals('777', $data['author_perm']);
      $this->assertEquals(\Papaya\CMS\Content\Options::INHERIT_PERMISSIONS_OWN, $data['surfer_useparent']);
      $this->assertEquals('1;2', $data['surfer_permids']);
      $this->assertGreaterThan(0, $data['topic_modified']);
      $this->assertEquals(99999, $data['topic_weight']);
      $this->assertEquals(1, (int)$data['box_useparent']);
    ...
    /**
     * @covers \Papaya\CMS\Content\Page\Work::createChild
     */
    public function testCreateChild() {
      ...
      $this->assertEquals(
        array(
          ...
          'created' => NULL,
          'modified' => NULL,
          'inherit_visitor_permissions' => \Papaya\CMS\Content\Options::INHERIT_PERMISSIONS_PARENT,
    ...
    /**
     * @covers \Papaya\CMS\Content\Page\Work::_createPublicationObject
     */
    ...
    /**
     * @covers \Papaya\CMS\Content\Page\Work::publish
     */
    ...
    /**
     * @covers \Papaya\CMS\Content\Page\Work::publish
     * @covers \Papaya\CMS\Content\Page\Work::_publishTranslations
     */
