...
class VersionsTest extends \Papaya\TestFramework\TestCase {
  /**
   * @covers \Papaya\CMS\Content\Page\Versions::load
   */
  ...
  /**
   * @covers \Papaya\CMS\Content\Page\Versions::getVersion
   */
