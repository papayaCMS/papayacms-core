...
class TranslationsTest extends \Papaya\TestFramework\TestCase {

  /**
   * @covers \Papaya\CMS\Content\Page\Version\Translations::load
   */
  ...
  /**
   * @covers \Papaya\CMS\Content\Page\Version\Translations::getTranslation
   */
