...
namespace Papaya\CMS\Configuration\Storage {
  ...
  class DomainTest extends \Papaya\TestFramework\TestCase {
    ...
    public function testDomainGetAfterSet() {
      $domain = $this->createMock(\Papaya\CMS\Content\Domain::class);
    ...
    public function testDomainGetImplicitCreate() {
      $storage = new Domain('sample.tld');
      $this->assertInstanceOf(\Papaya\CMS\Content\Domain::class, $storage->domain());
    }
      ...
      $domain
        ...
        ->willReturnCallback(
          static function ($option) {
            $options = [
              'mode' => \Papaya\CMS\Content\Domain::MODE_VIRTUAL_DOMAIN,
    ...
    public function testGetIterator() {
      ...
      $domain
        ...
        ->willReturnCallback(
          static function ($option) {
            $options = [
              'mode' => \Papaya\CMS\Content\Domain::MODE_DEFAULT,
              'options' => ['OPTION' => 'success']
            ];
            return $options[$option];
          }
