...
class DialogTest extends \Papaya\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Administration\Community\Users\Roster\Dialog::execute
   */
  public function testExecute() {
    $users = $this->createMock(\Papaya\CMS\Content\Community\Users::class);
    $users
      ->expects($this->once())
      ->method('load')
      ->with(
  ...
  /**
   * @covers \Papaya\CMS\Administration\Community\Users\Roster\Dialog::users
   */
  ...
  public function testUsersImplicitCreate() {
    $dialog = new Dialog();
    $this->assertInstanceOf(\Papaya\CMS\Content\Community\Users::class, $dialog->users());
  }

  /**
   * @covers \Papaya\CMS\Administration\Community\Users\Roster\Dialog::listview
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Community\Users\Roster\Dialog
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Community\Users\Roster\Dialog::paging
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Community\Users\Roster\Dialog::reference
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Community\Users\Roster\Dialog::setParameterNameMapping
   */
