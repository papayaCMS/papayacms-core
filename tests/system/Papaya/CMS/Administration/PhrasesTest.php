...
namespace Papaya\CMS\Administration {
  ...
  /**
   * @covers \Papaya\CMS\Administration\Phrases
   */
  class PhrasesTest extends TestCase {

    public function testConstructor() {
      /** @var \PHPUnit_Framework_MockObject_MockObject|PhrasesStorage $storage */
      $storage = $this->createMock(PhrasesStorage::class);
      /** @var \PHPUnit_Framework_MockObject_MockObject|ContentLanguage $language */
