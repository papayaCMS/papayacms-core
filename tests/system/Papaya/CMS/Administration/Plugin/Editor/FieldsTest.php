...
class FieldsTest extends \Papaya\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Administration\Plugin\Editor\Fields::dialog
   * @covers \Papaya\CMS\Administration\Plugin\Editor\Fields::createDialog
   */
  public function testDialogGetImplicitCreate() {
    $languageSwitch = $this->createMock(\Papaya\CMS\Administration\Languages\Selector::class);
    $languageSwitch
      ->expects($this->any())
      ->method('getCurrent')
      ->will(
  ...
  /**
   * @covers \Papaya\CMS\Administration\Plugin\Editor\Fields::builder
   */
