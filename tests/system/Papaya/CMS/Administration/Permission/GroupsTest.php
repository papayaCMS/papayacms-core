...
namespace Papaya\CMS\Administration\Permission;
...
class GroupsTest extends \Papaya\TestFramework\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Administration\Permission\Groups::__construct
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Permission\Groups::getIterator
   */
  ...
  public function testGetIteratorReturnsItems() {
    ...
    $this->assertArrayHasKey(
      \Papaya\CMS\Administration\Permissions::MESSAGES,
      $array[Groups::MISC]
    );
  }

  /**
   * @covers \Papaya\CMS\Administration\Permission\Groups::getGroupId
   */
  public function testGetGroupId() {
    $permissions = new Groups();
    $this->assertEquals(
      Groups::MISC,
      $permissions->getGroupId(\Papaya\CMS\Administration\Permissions::MESSAGES)
    );
  }
