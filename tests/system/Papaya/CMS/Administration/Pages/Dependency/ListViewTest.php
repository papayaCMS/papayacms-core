...
class ListViewTest extends \Papaya\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\ListView::appendTo
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\ListView::appendTo
   * @covers \Papaya\CMS\Administration\Pages\Dependency\ListView::prepare
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\ListView::pages
   */
  ...
  public function testPagesGetImplicitCreate() {
    ...
    $this->assertInstanceOf(
      \Papaya\CMS\Content\Pages::class, $listview->pages()
    );
  }
  ...
  /**
   * @param array $data
   * @return \PHPUnit_Framework_MockObject_MockObject|\Papaya\CMS\Content\Page\Dependencies
   */
  ...
  /**
   * @param array $data
   * @return \PHPUnit_Framework_MockObject_MockObject|\Papaya\CMS\Content\Page\References
   */
