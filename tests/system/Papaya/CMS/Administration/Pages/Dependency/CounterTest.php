...
namespace Papaya\CMS\Administration\Pages\Dependency {
  ...
  class CounterTest extends \Papaya\TestFramework\TestCase {

    /**
     * @covers \Papaya\CMS\Administration\Pages\Dependency\Counter::__construct
     */
    ...
    /**
     * @covers \Papaya\CMS\Administration\Pages\Dependency\Counter::load
     */
    public function testLoad() {
      ...
      $databaseAccess
        ...
        ->with(
          $this->isType('string'),
          array(
            'table_'.\Papaya\CMS\Content\Tables::PAGE_DEPENDENCIES,
            'table_'.\Papaya\CMS\Content\Tables::PAGE_REFERENCES,
            42
          )
        )
        ->will(
    ...
    /**
     * @covers \Papaya\CMS\Administration\Pages\Dependency\Counter::getDependencies
     * @covers \Papaya\CMS\Administration\Pages\Dependency\Counter::lazyLoad
     */
    public function testGetDependencies() {
      $counter = new \Papaya\CMS\Administration\Pages\Dependency\Counter_TestProxy(42);
      $this->assertEquals(
    ...
    /**
     * @covers \Papaya\CMS\Administration\Pages\Dependency\Counter::getReferences
     * @covers \Papaya\CMS\Administration\Pages\Dependency\Counter::lazyLoad
     */
    ...
    /**
     * @covers \Papaya\CMS\Administration\Pages\Dependency\Counter::getLabel
     * @covers \Papaya\CMS\Administration\Pages\Dependency\Counter::lazyLoad
