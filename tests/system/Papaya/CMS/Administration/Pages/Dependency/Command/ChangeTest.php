...
namespace Papaya\CMS\Administration\Pages\Dependency\Command;
...
class ChangeTest extends \Papaya\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Command\Change::createCondition
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Command\Change::validatePageId
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Command\Change::createDialog
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Command\Change::validateOriginAndSynchronizations
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Command\Change::validateOriginAndSynchronizations
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Command\Change::compareViewModules
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Command\Change::handleExecutionSuccess
   */
  public function testHandleExecutionSuccess() {
    $context = new \stdClass();
    $context->dependency = $this->createMock(\Papaya\CMS\Content\Page\Dependency::class);
    $context->synchronizations =
    $synchronizations =
      $this->createMock(\Papaya\CMS\Administration\Pages\Dependency\Synchronizations::class);
    $synchronizations
      ->expects($this->once())
      ->method('synchronizeDependency')
      ->with($this->isInstanceOf(\Papaya\CMS\Content\Page\Dependency::class));
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Command\Change::dispatchErrorMessage
   */
  ...
  public function getSynchronizationsFixture() {
    $synchronizations = $this->createMock(\Papaya\CMS\Administration\Pages\Dependency\Synchronizations::class);
    $synchronizations
      ->expects($this->any())
      ->method('getList')
      ->will(
