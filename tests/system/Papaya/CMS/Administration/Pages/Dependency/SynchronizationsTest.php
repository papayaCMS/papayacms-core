...
class SynchronizationsTest extends \Papaya\TestFramework\TestCase {

  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronizations::getIcons
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronizations::getList
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronizations::dependencies
   */
  ...
  public function testDependenciesGetImplicitCreate() {
    $synchronizations = new Synchronizations();
    $this->assertInstanceOf(\Papaya\CMS\Content\Page\Dependencies::class, $synchronizations->dependencies());
  }

  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronizations::getAction
   */
  public function testGetAction() {
    $synchronizations = new Synchronizations();
    $action = $synchronizations->getAction(\Papaya\CMS\Content\Page\Dependency::SYNC_PROPERTIES);
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronizations::getTargets
   */
  public function testGetTargets() {
        ...
        $this->returnValue(
          new \ArrayIterator(
            array(
              23 => array(
                'id' => 23,
                'synchronization' => \Papaya\CMS\Content\Page\Dependency::SYNC_PROPERTIES
              ),
              46 => array(
                'id' => 46,
                'synchronization' => 0
    ...
    $this->assertEquals(
      array(23),
      $synchronizations->getTargets(42, \Papaya\CMS\Content\Page\Dependency::SYNC_PROPERTIES)
    );
  }
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronizations::synchronizeDependency
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronizations::synchronizeAction
   */
  public function testSynchronizeAction() {
    ...
    $synchronizations->synchronizeAction(
      \Papaya\CMS\Content\Page\Dependency::SYNC_PROPERTIES, 42, array(3, 4)
    );
  }
