...
class PropertiesTest extends \Papaya\TestFramework\TestCase {

  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronization\Properties::page
   */
  ...
  /**
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronization\Properties::synchronize
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronization\Properties::updateTranslations
   * @covers \Papaya\CMS\Administration\Pages\Dependency\Synchronization\Properties::updatePages
   */
   ...
   * @param \Papaya\CMS\Content\Page\Translation|\PHPUnit_Framework_MockObject_MockObject|NULL $translation
   * @return \PHPUnit_Framework_MockObject_MockObject|\Papaya\CMS\Content\Page\Translations
   */
