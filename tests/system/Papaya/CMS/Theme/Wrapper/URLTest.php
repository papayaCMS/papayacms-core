...
namespace Papaya\CMS\Theme\Wrapper;
...
class URLTest extends \Papaya\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper\URL::getMimetype
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper\URL::getThemeSet
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper\URL::parameters
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper\URL::getFiles
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper\URL::getGroup
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper\URL::getTheme
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper\URL::allowDirectories
   */
