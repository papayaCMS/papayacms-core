...
class CollectionTest extends \Papaya\TestFramework\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Theme\Collection::getIterator
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Collection::getDefinition
   */
  public function testGetDefinition() {
    ...
    $handler
      ...
      ->with('theme-sample')
      ->will($this->returnValue(new \Papaya\CMS\Content\Structure()));
    $list = new Collection();
    $list->handler($handler);
    $this->assertInstanceOf(
      \Papaya\CMS\Content\Structure::class,
      $list->getDefinition('theme-sample')
    );
  }

  /**
   * @covers \Papaya\CMS\Theme\Collection::handler
   */
