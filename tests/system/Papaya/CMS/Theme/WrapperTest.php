...
class WrapperTest extends \Papaya\TestCase {
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper::__construct
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper::group
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper::handler
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper::themeSet
   */
  ...
  public function testThemeSetGetHandlerImplicitCreate() {
    ...
    $this->assertInstanceOf(\Papaya\CMS\Content\Theme\Skin::class, $themeSet);
    $this->assertSame($application, $themeSet->papaya());
  }

  /**
   * @covers \Papaya\CMS\Theme\Wrapper::templateEngine
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper::cache
   */
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper::getCompiledContent
  ...
  public function testGetCompiledContentUsingTemplates() {
    ...
    $handler
      ...
      ->willReturn($this->createMock(\Papaya\CMS\Theme\Definition::class));
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper::getFiles
   * @covers \Papaya\CMS\Theme\Wrapper::prepareFileName
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper::getCacheIdentifier
  ...
  /**
   * @covers \Papaya\CMS\Theme\Wrapper::getResponse
   */
