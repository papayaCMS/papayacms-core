...
namespace Papaya\Utility {
  ...
  class ArraysTest extends \PapayaTestCase {
    ...
    public function testEnsure(array $expected, $input, $useKeys = TRUE) {
      $this->assertSame($expected, Arrays::ensure($input, $useKeys));
    }
    ...
    public function testGetWithExistingElement() {
      $this->assertEquals(
        'success', Arrays::get(array('test' => 'success'), 'test')
      );
    }
    ...
    public function testGetWithListArgumentSecondIndexExists() {
      $this->assertEquals(
        'success', Arrays::get(array('test' => 'success'), array('non-existing', 'test'))
      );
    }
    ...
    public function testGetWithNonexistingElementFetchingDefault() {
      $this->assertEquals(
        'success', Arrays::get(array('test' => 'fail'), 'sample', 'success')
      );
    }
    ...
    public function testGetWithListArgumentFetchingDefault() {
      $this->assertEquals(
        'success', Arrays::get(array('test' => 'fail'), array('sample', 99), 'success')
      );
    }
    ...
    public function testGetWithEmptyIndexFetchingDefault() {
      $this->assertEquals(
        'success', Arrays::get(array(), NULL, 'success')
      );
    }
    ...
    public function testDecodeIdList() {
      $this->assertEquals(
        array(21, 42), Arrays::decodeIdList(';21;42;')
      );
    }
    ...
    public function testEncodeIdList() {
      $this->assertEquals(
        '21;42', Arrays::encodeIdList(array(21, 42))
      );
    }
    ...
    public function testEncodeAndQuoteIdList() {
      $this->assertEquals(
        ';21;42;', Arrays::encodeAndQuoteIdList(array(21, 42))
      );
    }
    ...
    public function testNormalizeWithCallback() {
      $input = 23;
      Arrays::normalize($input, function ($value) {
    ...
    public static function toArrayDataProvider() {
      return array(
        ...
        'IteratorAggregate' => array(
          array('foo' => 'bar'),
          new Arrays_TestProxyArrayIterator(array('foo' => 'bar')),
        ),
        'Traversable' => array(
          array('foo' => 'bar'),
          new Arrays_TestProxyTraversable(array('foo' => 'bar')),
        ),
  ...
  class Arrays_TestProxyArrayIterator implements \IteratorAggregate {
  ...
  class Arrays_TestProxyTraversable implements \Iterator {
