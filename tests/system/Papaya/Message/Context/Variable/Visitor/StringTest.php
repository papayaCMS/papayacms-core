...
class PapayaMessageContextVariableVisitorStringTest extends \PapayaTestCase {
  ...
  */
  public function testGet() {
    $visitor = new \Papaya\Message\Context\Variable\Visitor\Text(21, 42);
    $this->assertSame(
      '',
      $visitor->get()
    );
  ...
  */
  public function testVisitArrayWithNestedArrayReachingLimit() {
    $visitor = new \Papaya\Message\Context\Variable\Visitor\Text(1, 42);
    $visitor->visitArray(array(array()));
    $this->assertAttributeEquals(
      "array(1) {\n  ...recursion limit...\n}",
      '_variableString',
  ...
  */
  public function testVisitLongString() {
    $visitor = new \Papaya\Message\Context\Variable\Visitor\Text(21, 3);
    $visitor->visitString('Sample');
    $this->assertAttributeEquals(
      'string(6) "Sam..."',
      '_variableString',
