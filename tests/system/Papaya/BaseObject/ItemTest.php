...
namespace Papaya\BaseObject {
  ...
  class ItemTest extends \Papaya\TestFramework\TestCase {
    ...
    public function testToArray() {
      $item = new Item_TestProxy(array('sample_one', 'sample_two'));
      $item->assign(
        array(
          'sample_one' => 21,
          'sample_two' => 42
    ...
    public function testPropertyConvert($name, $normalizedName) {
      $item = new Item_TestProxy(array($name));
      $item[$name] = 'success';
      $this->assertEquals(
    ...
    public function testPropertyValidationExpectingExceptionForUnknown() {
      $item = new Item_TestProxy(array());
      $this->expectException(\OutOfBoundsException::class);
      $this->expectExceptionMessage('Property/Index "test" is not defined for item class "Papaya\BaseObject\Item_TestProxy".');
