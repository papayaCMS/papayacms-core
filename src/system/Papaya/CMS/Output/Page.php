...
class Page implements Application\Access {
  ...
  /**
   * @param \Papaya\CMS\Content\Page $page
   *
   * @return \Papaya\CMS\Content\Page|Content\Page\Publication
   */
    ...
    if (!empty($moduleGuid)) {
      ...
      if ($plugin) {
        ...
        if ($plugin instanceof \Papaya\Plugin\Quoteable) {
          if ($plugin instanceof \Papaya\Plugin\Configurable\Context) {
   ...
   */
  public function reference(PageReference $reference = NULL) {
    if (NULL !== $reference) {
