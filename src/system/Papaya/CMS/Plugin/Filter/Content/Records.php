...
/**
 * Class Papaya\CMS\Plugin\Filter\Content\Records
 */
class Records extends Group {
  ...
  /**
   * @param \Papaya\CMS\Content\View\Configurations|null $configurations
   * @return \Papaya\CMS\Content\View\Configurations
   */
