...
namespace Papaya\CMS\Administration\Media {
  ...
  use Papaya\CMS\Administration\UI\ListView\ViewToggle;
  use Papaya\CMS\Administration\UI\Navigation\Reference\MimeTypeIcon;
  use Papaya\CMS\Content\Media\Files;
