...
class Dialog
  ...
  /**
   * @var \Papaya\CMS\Content\Structure\Page
   */
  private $_themePage;
   ...
   *
   * @param \Papaya\CMS\Theme\Handler $themeHandler
   *
   * @return \Papaya\CMS\Theme\Handler
   */
  public function themeHandler(\Papaya\CMS\Theme\Handler $themeHandler = NULL) {
