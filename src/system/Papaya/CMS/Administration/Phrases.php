...
use Papaya\CMS\Administration\Phrases\Groups as PhraseGroups;
use Papaya\CMS\Administration\Phrases\Storage as PhraseStorage;
use Papaya\CMS\Content\Language as LanguageContent;
use Papaya\UI\Text\Phrases as TextPhrases;
 ...
 * @property LanguageContent $language
 */
class Phrases implements Application\Access, Properties, TextPhrases {
  ...
  public function __construct(Phrases\Storage $storage, LanguageContent $language) {
  ...
  /**
   * @param LanguageContent $language
   */
  public function setLanguage(LanguageContent $language) {
   ...
   * @return string
   */
  public function getText(string $phrase, string $groupName = NULL): ?string {
