...
// trigger alias creation for type hint BC
  ...
  abstract class Part extends UI\Control\Interactive {
     ...
     * {@see \Papaya\CMS\Administration\Page\Part::_createCommands89} is called for lazy init
     *
     ...
     * after all page parts are appended. The order of the sets is different from the page parts
