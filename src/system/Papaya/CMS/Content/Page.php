 ...
 *
 * This is an abstract superclass, please use {@see \Papaya\CMS\Content\Page\Work} to modify the
 * working copy of a page or {@see \Papaya\CMS\Content\Page\Publication} to use the published page.
 *
