...
/**
 * Defines the tables used by the \Papaya\CMS\Content\* classes. Allows to prefix the
 * current table name with the defined table prefix.
 *
 * @package Papaya-Library
 * @subpackage Content
 */
class Tables extends \Papaya\Application\BaseObject implements \Papaya\Database\Tables {
   ...
   * @return string
   */
  public function get(string $tableName, bool $prefix = TRUE): string {
