...
namespace Papaya\Configuration {
  ...
  class CMS extends GlobalValues {
    ...
    const CONSENT_COOKIE_REQUIRE = 'PAPAYA_CONSENT_COOKIE_REQUIRE';
    const CONSENT_COOKIE_NAME = 'PAPAYA_CONSENT_COOKIE_NAME';
    const CONSENT_COOKIE_LEVELS = 'PAPAYA_CONSENT_COOKIE_LEVELS';
