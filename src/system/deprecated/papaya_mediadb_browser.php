...
class papaya_mediadb_browser extends base_mediadb {
  ...
  */
  function initialize() {
    $this->dataDirectory = $this->papaya()->options->get(\Papaya\CMS\CMSConfiguration::PATH_MEDIAFILES);
    $this->thumbnailDirectory = $this->papaya()->options->get(\Papaya\CMS\CMSConfiguration::PATH_THUMBFILES);
