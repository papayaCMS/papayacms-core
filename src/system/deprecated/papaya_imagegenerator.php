  ...
  */
  function initializeImageConfDialog() {
    if (!(isset($this->dialogImageConf) && is_object($this->dialogImageConf))) {
      ...
      $systemImageFormat = $this->papaya()->options->get(\Papaya\CMS\CMSConfiguration::THUMBS_FILETYPE);
      $imageFormats = array(
      ...
      $systemCacheTime = $this->papaya()->options->get(\Papaya\CMS\CMSConfiguration::CACHE_TIME_FILES);
      $cacheModes = array(
        0 => $this->_gt('No Cache'),
