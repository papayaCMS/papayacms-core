  ...
  */
    ...
    if (function_exists('uploadprogress_get_info')) {
      ...
      if (\Papaya\Filter\Factory::isGuid($id, FALSE)) {
        ...
        if ($ulInfo) {
          ...
          $this->info[$id] = [
            'status' => self::UPLOADSTATUS_FINISHED,
        ...
        $this->info[0] = [
          'status' => self::UPLOADSTATUS_INVALID_ID,
      ...
      $this->info[0] = [
        'status' => self::UPLOADSTATUS_NO_EXTENSION,
  ...
  function getUploadProgressInfo($id) {
    if ($arrUploadInfo = uploadprogress_get_info($id)) {
      ...
      return [
        'id' => $id,
        'status' => self::UPLOADSTATUS_PROGRESS,
