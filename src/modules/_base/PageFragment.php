...
namespace Papaya\Modules\Core {
  ...
  class PageFragment extends Partials\Teaser implements RoutablePlugin {
    ...
    public function createEditor(
      EditablePlugin\Content $content, $teaserRTEMode = DialogField\Textarea\Richtext::RTE_DEFAULT
    ) {
      return parent::createEditor($content, $teaserRTEMode); // TODO: Change the autogenerated stub
    }
  }
}
